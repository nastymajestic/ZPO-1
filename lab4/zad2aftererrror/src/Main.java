...
public class Main {
    public static void main(String[] args) {
       ...
       // System.out.println(hmapPolEng);                                 // wypisywanie hashMapy
        ...
        Set<String> kluczePolskieSet = hmapPolEng.keySet(); // tu mamy magiczne klucze po polsku

        //System.out.println(key);
        String[] tablicaStringow = new String[15];
        kluczePolskieSet.toArray(tablicaStringow);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            do {
                index = draw.nextInt(HowManyWordsExists);
            }while(indexArray.contains(indexArray));
...
//            JFrame frame3 = new JFrame("VocabTest");
            ...
            for (String translate : hmapPolEng.get(listKey.get(index))) {               //https://stackoverflow.com/questions/18389135/how-to-verify-if-a-value-in-hashmap-exist
                //if()
